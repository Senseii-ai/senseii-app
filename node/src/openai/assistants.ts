...
export const FitnessAssistant = process.env.FITNESS_ASSISTANT;
export const NutritionAssistant = process.env.NUTRITION_ASSISTANT;
export const CoreAssistant = process.env.CORE_ASSISTANT;
